  ...
  return (
    <div>
      <div className='menuPersona'>
        ...
        <input className='aficheVer' type='file' ></input>
        <input style = {{position: 'absolute', top: 270, left: 150, fontSize: 20}}  ></input>

        <div className='contenedorVerDatePicker' >
          <DatePicker
            selected={fecha}
        ...
        <select className='selectVerResponsable'>
        ...
        <select className='selectVerTipo'>
        ...
        <select className='selectVerEstado'>
        ...
        <select className='selectVerVirPre'>
            <option value="">Selecciona el Tipo</option>
        ...
        <button className='eliminarActividad'>Eliminar Actividad</button>
        <button className='modificarActividad'>Modificar Actividad</button>
        <button className='volverVerActividad'>Volver</button>
      </div>
    </div>
  );
}
